...
<h2 id="section-2">0.3.1</h2>

- 修复图片缩小到截图框以下再回弹时出现的位置偏移
- 修复横图回弹后向右移动、竖图回弹后向下移动的问题
- 补充横图与竖图缩放回弹的边界回归测试

<h2 id="section-3">0.3.0</h2>
...
<h2 id="section-6">0.1.2</h2>

- 新增导出参数：`original`（抵消图片当前缩放，按原图像素导出）
...
- Added export prop: `original` (undo the current image scale for export)
